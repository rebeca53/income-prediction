...
def dummy_code_state(state_code):
    ...
    return list(dummy_state_values.values())
...
def dummy_color_race(race_code):
    ...
    return list(dummy_race_values.values())
...
for visit in [visit2019, visit2020, visit2021, visit2022]:
    ...
    with open(visit.txt_file_name, 'r') as in_file, open(visit.csv_file_name, 'w', newline='') as out_file:
        ...
        writer.writerow(('YEAR', 'SEX', 'RDUMMY_WHITE', 'RDUMMY_BLACK', 'RDUMMY_ASIAN', 'RDUMMY_MIXED', 'RDUMMY_NATIVE', 'RDUMMY_OTHER', 
                         ...
                         'SDUMMY_PR','SDUMMY_SC','SDUMMY_RS','SDUMMY_MS','SDUMMY_MT','SDUMMY_GO','SDUMMY_DF', 'YEARS_OF_STUDY', 'INCOME', 'LOG_INCOME'))
        ...
        for line in lines:
            ...
            row.extend(dummy_code_state(state_code))
